...
public final class Sistema extends javax.swing.JFrame {
    ...
    Validaciones event = new Validaciones();
    ...
    public Sistema(Login priv) {
        ...
        // Configuración de permisos y campos
    ...
    private void actualizarTabla() {
        ...
        List<Platos> lista = platosDAO.Listar("");
        DefaultTableModel modelo = (DefaultTableModel) TablePlatos.getModel();
        modelo.setRowCount(0);
        for (Platos plato : lista) {
            modelo.addRow(new Object[]{plato.getId(), plato.getNombre(), plato.getPrecio(), plato.getFecha()});
        }
    }
    ...
    private void initComponents() {
        ...
        btnRegistrarSala.setBackground(new java.awt.Color(150, 227, 215));
        ...
        btnActualizarSala.setBackground(new java.awt.Color(150, 227, 215));
        ...
        btnNuevoSala.setBackground(new java.awt.Color(150, 227, 215));
        ...
        btnEliminarSala.setBackground(new java.awt.Color(150, 227, 215));
        ...
        btnAddPlato.setBackground(new java.awt.Color(150, 227, 215));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(41, 41, 41)
                .addComponent(btnSala, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(41, 41, 41)
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(14, 14, 14)
                        .addComponent(labelLogo, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(120, 120, 120)
                                .addComponent(tipo))
        ...
        jTabbedPane1.setUI(new javax.swing.plaf.basic.BasicTabbedPaneUI() {
            ...
            protected int calculateTabAreaHeight(int tabPlacement, int runCount, int maxTabHeight) {
                return 0;  // Ocultar la barra de pestañas
            }
        });
    ...
    private void btnGuardarPlatoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarPlatoActionPerformed
        ...
        java.sql.Date fechaSql = java.sql.Date.valueOf(fechaFormato);  // Conversión de String a java.sql.Date
        ...
        if (!"".equals(txtNombrePlato.getText()) || !"".equals(txtPrecioPlato.getText())) {
            ...
            pla.setFecha(fechaSql); // Aquí ya se usa la fecha correctamente convertida
    ...
    private void ListarPlatos(JTable tabla) {
        List<Platos> lista = plaDao.Listar(txtBuscarPlato.getText());
    ...
    private void registrarPedidoConDetalles() {
        // Crear una instancia de frmLogin
        frmLogin loginFrame = new frmLogin();

        // Obtener el usuario desde la instancia
        String usuario = loginFrame.getUsuario();  // Llamar al método no estático
        ...
        Pedidos ped = new Pedidos();  // Crear un nuevo objeto Pedidos
        ped.setId_sala(id_sala);
        ped.setNum_mesa(num_mesa);
        ped.setTotal(monto);
        ped.setUsuario(usuario);  // Asignar el usuario al pedido
        ...
        for (int i = 0; i < tableMenu.getRowCount(); i++) {
            ...
            detalle.setComentario(tableMenu.getValueAt(i, 5).toString());
            detalles.add(detalle);
        }

        // Registrar el pedido y sus detalles
        boolean registrado = pedDao.registrarPedidoConDetalles(ped, detalles);
